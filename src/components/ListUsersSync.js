...
const DiceSvg = () => (
  ...
  >
    <circle cx="256" cy="256" r="256" fill="#000" fillOpacity="1"></circle>
    <g class="" transform="translate(0,0)" style={{ touchAction: "none" }}>
      <path
...
const DiceIcon = (props) => <Icon component={DiceSvg} {...props} />;
  ...
  return (
    <>
      ...
      <Tooltip title="Next">
        <Button
          type="text"
          style={{ height: "3em", width: "3em", marginTop: "8px" }}
          icon={<DiceIcon />}
